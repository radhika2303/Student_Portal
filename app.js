...
app.post("/register", function(req,res) {
	User.register(new User({username:req.body.username,F_Name: req.body.F_Name,M_Name: req.body.M_Name,L_Name: req.body.L_Name,Year: req.body.Year,Branch: req.body.Branch,Street_Name: req.body.Street_Name,Street_No: req.body.Street_No}), req.body.password, function(err,user) {
		if(err) {
			console.log(err);
